...
User: TRUONGHUYHOANG-\Hoang
    ...
    sourcetype = XmlWinEventLog:Sysmon
```
Sự kiện chỉnh sửa cấu hình TCP/IP – Thay đổi Registry hệ thống

📌 Thời gian (UTC): 2026-03-05 06:57:57.846

📌 Thời gian (giờ địa phương – UTC+7): ~13:57:57
...
Technique ID: T1562
Technique Name: Impair Defenses (liên quan gián tiếp)
Tactic: Defense Evasion

📌 Mức độ nghi vấn: Thấp đến Trung bình, phụ thuộc ngữ cảnh
...
- Kiểm tra parent process của PowerShell
- Xác định thay đổi có nằm trong change management hay không
- Kiểm tra có hành vi:
    - Thay đổi registry khác
    - Script automation liên quan
    - Dấu hiệu bất thường trong cùng tiến trình

Nếu không nằm trong thay đổi hợp lệ → cần theo dõi thêm trong attack chain
